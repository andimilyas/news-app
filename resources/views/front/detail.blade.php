            ...
            <div class="side-bar flex flex-col w-[300px] shrink-0 gap-10">
                <div class="ads flex flex-col gap-3 w-full">
                    <a href="{{ $squareAds_1->link }}">
                        <img src="{{ Storage::url($squareAds_1->thumbnail) }}" class="object-contain w-full h-full"
                            alt="ads" />
                    </a>
                ...
                <div id="More-from-author" class="flex flex-col gap-4">
                    ...
                    <a href="{{ route('front.detail', $item->slug) }}" class="card-from-author">
                        <div
                            ...
                            <div class="w-[70px] h-[70px] flex shrink-0 overflow-hidden rounded-2xl">
                                <img src="{{ Storage::url($item->thumbnail) }}" class="object-cover w-full h-full"
                                    alt="thumbnail">
                            </div>
                            <div class="flex flex-col gap-[6px]">
                                <p class="line-clamp-2 font-bold">{{ $item->name }}</p>
                                <p class="text-xs leading-[18px] text-[#A3A6AE]">{{ $item->created_at->format('d M Y') }} • {{ $item->category->name }}</p>
                            </div>
                        </div>
                    </a>
                    @endforeach
