                            ...
                            <a href="{{ route('front.detail', $entertainmentarticle->slug) }}" class="card py-[2px]">
                                <div
                                    ...
                                    <div class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
                                        <img src="{{ Storage::url($entertainmentarticle->thumbnail) }}"
                                    ...
                                    <div class="flex flex-col justify-center-center gap-[6px]">
                                        <h3 class="font-bold text-lg leading-[27px]">
                                            {{ substr($entertainmentarticle->name, 0, 50) }}{{ strlen($entertainmentarticle->name) > 50 ? '...' : '' }}
                                        </h3>
                                        <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                            {{ $entertainmentarticle->created_at->format('d M, Y') }}</p>
                                    </div>
                                </div>
                            </a>
                        @empty
                        ...
                        @forelse($businessArticles as $businessarticle)
                            <a href="{{ route('front.detail', $businessarticle->slug) }}" class="card py-[2px]">
                                <div
                                    class="rounded-[20px] border border-[#EEF0F7] p-[14px] flex items-center gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300">
                                    <div class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
                                        <img src="{{ Storage::url($businessarticle->thumbnail) }}"
                                            class="object-cover w-full h-full" alt="thumbnail" />
                                    </div>
                                    <div class="flex flex-col justify-center-center gap-[6px]">
                                        <h3 class="font-bold text-lg leading-[27px]">
                                            {{ substr($businessarticle->name, 0, 50) }}{{ strlen($businessarticle->name) > 50 ? '...' : '' }}
                                        </h3>
                                        <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                            {{ $businessarticle->created_at->format('d M, Y') }}</p>
                                    </div>
                                </div>
                            </a>
                        @empty
                        ...
                        @forelse($automotiveArticles as $automotivearticle)
                            <a href="{{ route('front.detail', $automotivearticle->slug) }}" class="card py-[2px]">
                                <div
                                    class="rounded-[20px] border border-[#EEF0F7] p-[14px] flex items-center gap-4 hover:ring-2 hover:ring-[#FF6B18] transition-all duration-300">
                                    <div class="w-[130px] h-[100px] flex shrink-0 rounded-[20px] overflow-hidden">
                                        <img src="{{ Storage::url($automotivearticle->thumbnail) }}"
                                            class="object-cover w-full h-full" alt="thumbnail" />
                                    </div>
                                    <div class="flex flex-col justify-center-center gap-[6px]">
                                        <h3 class="font-bold text-lg leading-[27px]">
                                            {{ substr($automotivearticle->name, 0, 50) }}{{ strlen($automotivearticle->name) > 50 ? '...' : '' }}
                                        </h3>
                                        <p class="text-sm leading-[21px] text-[#A3A6AE]">
                                            {{ $automotivearticle->created_at->format('d M, Y') }}</p>
                                    </div>
                                </div>
                            </a>
                        @empty
